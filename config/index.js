export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe4e3d44f0df1fa03",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "495db0ff7a4c28851c8862270a1c43ab",
  ...
  USERS: [
    {
      ...
      id: "o5QO852vSY1gaLVcSIjqkjOkTzkw",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "j6lZc-aHWSd1aNvuJ2yj2cqAEujvFJSBFIflEVFI7P8",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "南京",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "小陈", "year": "1994", "date": "07-04"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "小吴", "year": "2000", "date": "10-15"},
        {"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "11-01"},
      ],
